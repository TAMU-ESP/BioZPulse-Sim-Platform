...
fprintf(' ,I1 loc.=(%2g,%2g) I2 loc.=(%2g,%2g)',net.param.i_src_n1i,net.param.i_src_n1j,net.param.i_src_n2i,net.param.i_src_n2j);
if exist('net.param.r_var_freq')
    fprintf(', ZA=(%2g,%2g)\n',net.param.r_var_n1k,net.param.r_var_dia);
else
    fprintf('\n');
end
...
net.param.plot_path=strcat('./netlist/',net.param.date,'_',net.param.write_netlist);

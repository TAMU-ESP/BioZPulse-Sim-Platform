...
%
%   Simulate arterial pulse amplitude(deltaV_PP) when sensing location is aligned with the artery
...
figure
surf([0:net_t_i_t1_arr.Nj],[0:net_t_i_t1_arr.Ni-1],net_t_i_t1_arr.V_sns_v_diff(:,:,1)*1e3)

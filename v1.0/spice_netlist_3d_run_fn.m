...
fprintf('Dimensions=(%2g,%2g,%2g)',net.Ni+1,net.Nj+1,net.Nk+1);
...
if ~isempty(net.param.s_n1i)
    fprintf('Elec. size=(%g,%g), Sense Elec. 1 loc.=(%g,%g), Sense Elec. 2 loc.=(%g,%g)\n',net.param.s_dia_x,net.param.s_dia_y,net.param.s_n1i(1),net.param.s_n1j(1),net.param.s_n2i(1),net.param.s_n2j(1));
end

res_folder=strcat('./results/',date,'_',net.param.write_netlist,'/');
...
if net.param.debug==0    
    ...
    cmd=strcat({'"'},net.param.ltspice_path,{'" -b -ascii '},net.param.circuit_file);
    status=system(cmd{1});
    if status==0

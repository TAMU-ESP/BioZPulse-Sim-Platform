...
if net.param.r_var_max(1)>0
    for s=1:length(net.param.r_var_n1j)
        ...
        elseif net.param.r_var_dim==2
            n1i=net.param.r_var_n1i+[0 0 1 0];
            n1j=net.param.r_var_n1j+[0 1 0 0];
            n2i=net.param.r_var_n1i+[0 1 1 1];
            n2j=net.param.r_var_n1j+[1 1 1 0];
            n1k=net.param.r_var_n1k+[0 0 0 0];
            n2k=net.param.r_var_n1k+[0 0 0 0];
            delay=[0,0,0,0];
...
if net.param.debug==0
    ...
    subplot(1,2,1)
    heatmap([0:net.Nj],[0:net.Ni],squeeze(net.node_arr(:,:,1)),'Colormap',white,'MissingDataLabel','I Elec.');
    title('Current Injection Location (Black square), Z=0')
    subplot(1,2,2)
